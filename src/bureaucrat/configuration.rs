    ...
    */
    pub fn as_url(&self) -> String
    {
        ...
        let location = format!(
            ...
            host = self.host,
            port = self.port,
            auth_separator = match self.password.as_str()
            {
                "" => "",
                _ => ":",
            },
            at_sign = match self.username.as_str()
            {
                "" => "",
                _ => "@",
            },
            port_separator = match self.port.as_str()
            {
                "" => "",
                _ => ":",
            }
        ...
        format!(
            ...
            database_separator = match self.database.as_str() == "" || location.as_str() == SCHEMA
            {
                true => "",
                false => "/",
            }
