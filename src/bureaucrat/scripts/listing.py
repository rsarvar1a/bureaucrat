...
class ScriptListView(ui.View):
    ...
    @classmethod
    async def create(cls, *, interaction: Interaction, bot: "Bureaucrat", author: Optional[int] = None, name: Optional[str] = None, page_size: Optional[int] = None, followup: bool = False):
